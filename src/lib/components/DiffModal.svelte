...
<button class="scrim" aria-label={i18n.t("diff.close")} onclick={onClose}></button>
<div class="box" role="dialog" aria-modal="true" aria-label={i18n.t("diff.aria", { name })}>
  <header class="head">
    <div class="titles">
  ...
  <div class="body">
    ...
    {:else if data && data.onDisk === null}
      <p class="muted">{i18n.t("diff.missing")}</p>
