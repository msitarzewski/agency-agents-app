...
<div class="section">
  <h2>{i18n.t("settings.activity")}</h2>

  <div class="field">
    <label for="max-jobs">{i18n.t("activitySettings.keepJobs")}</label>
    <input
      id="max-jobs"
      type="number"
      class="num"
    ...
    />
    <p class="hint">
      {i18n.t("activitySettings.rangeDefault", { min: ACTIVITY_MAX_JOBS_MIN, max: ACTIVITY_MAX_JOBS_MAX, value: ACTIVITY_MAX_JOBS_DEFAULT })}
    </p>
  </div>

  <div class="field">
    <label for="max-lines">{i18n.t("activitySettings.linesPerJob")}</label>
    <input
      id="max-lines"
      type="number"
      class="num"
    ...
    />
    <p class="hint">
      {i18n.t("activitySettings.rangeDefault", { min: ACTIVITY_MAX_LINES_MIN, max: ACTIVITY_MAX_LINES_MAX, value: ACTIVITY_MAX_LINES_DEFAULT })}
    </p>
  </div>

  <p class="note">
    {i18n.t("activitySettings.note")}
  </p>
</div>
